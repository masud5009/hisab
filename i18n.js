// ============================================================
// i18n.js
// Lightweight bilingual translation helper (Bengali & English)
// ============================================================
...
export const translations = {
  en: {
    ...
    more_menu: "More Menu",
    quick_actions: "Quick Actions & History",
    ...
    nav_meals: "Add Meals",
    nav_history: "History",
    nav_additional_costs: "Additional Costs",
    nav_users: "Manage Users",
    nav_add_user: "Add Member",
    ...
    btn_remind_meals: "Meal Reminder",
    modal_meal_reminder_title: "Today's Missing Meal Reminders",
    all_meals_added_today: "All members have already added meals for today!",
    btn_send_wa: "Send WhatsApp",
    btn_share_group_reminder: "Share to Mess Group",
    lbl_missing_meal_count: "members haven't added today's meal",
    btn_add: "Add",
    ...
    th_lunch: "Lunch",
    th_dinner: "Dinner",
    th_total_meals: "Total Meals",
    th_bazar: "Bazar",
    th_base_rate: "Base Rate",
    th_dinner_rate: "Dinner Rate",
    th_lunch_rate: "Lunch Rate",
    th_meal_cost: "Meal Cost",
    th_khala: "Khala",
    th_gas: "Gas",
    th_electricity: "Electricity",
    th_wifi: "WiFi",
    th_bari_vara: "Bari Vara",
    th_additional: "Additional",
    th_due: "Due",
    th_pay: "Pay",
    th_actions: "Actions",
    th_share: "Share",
    ...
    cost_composition: "Expense Breakdown",
    personal_breakdown: "Personal Expense vs Bazar Deposit",
    share_breakdown: "Financial Position",
  ...
  bn: {
    ...
    member_panel: "মেম্বার প্যানেল",
    more_menu: "মেনু",
    quick_actions: "কুইক অ্যাকশন ও হিস্ট্রি",
    all_navigation: "সকল নেভিগেশন",
    ...
    nav_additional_costs: "অতিরিক্ত খরচ",
    nav_users: "মেম্বার তালিকা",
    nav_add_user: "মেম্বার যোগ",
    nav_settings: "সেটিংস ও বিল",
    nav_logout: "লগআউট",
    ...
    room_rent: "ঘর ভাড়া",
    base_rate: "বেস রেট",
    dinner_rate: "রাতের রেট",
    lunch_rate: "দুপুরের রেট",
    morning_rate: "সকালের রেট",
    rate_percent: "রেট %",
    members: "মোট সদস্য",
    my_bazar: "আমার বাজার",
    my_meals: "আমার মিল",
    ...
    btn_remind_meals: "মিল রিমাইন্ডার",
    modal_meal_reminder_title: "আজকের মিল রিমাইন্ডার",
    all_meals_added_today: "আজকের সব মেম্বারের মিল এন্ট্রি সম্পন্ন হয়েছে!",
    btn_send_wa: "হোয়াটসঅ্যাপে পাঠান",
    btn_share_group_reminder: "মেস গ্রুপে শেয়ার",
    lbl_missing_meal_count: "জন মেম্বার আজকের মিল এন্ট্রি দেননি",
    btn_add: "যুক্ত করুন",
    ...
    th_lunch: "দুপুর",
    th_dinner: "রাত",
    th_total_meals: "মোট মিল",
    th_bazar: "বাজার জমা",
    th_base_rate: "বেস রেট",
    th_dinner_rate: "রাতের রেট",
    th_lunch_rate: "দুপুরের রেট",
    th_meal_cost: "মিল খরচ",
    th_khala: "খালা",
    th_gas: "গ্যাস",
    th_electricity: "বিদ্যুৎ",
    th_wifi: "ওয়াইফাই",
    th_bari_vara: "ঘর ভাড়া",
    th_additional: "অতিরিক্ত",
    th_due: "বকেয়া",
    th_pay: "পাওনা",
    th_actions: "অ্যাকশন",
    th_share: "শেয়ার",
    ...
    // Visual Analytics
    analytics_overview: "হিসাব ও খরচের বিশ্লেষণ",
    meal_distribution: "মিলের অনুপাত ও বণ্টন",
    cost_composition: "মেসের খরচের খাতসমূহ",
    personal_breakdown: "আমার ব্যক্তিগত খরচ বনাম বাজার জমা",
    share_breakdown: "ব্যালেন্সের অবস্থান",
...
export function getLanguage() {
  ...
  return "bn"; // Default to Bengali for local mess users
}
